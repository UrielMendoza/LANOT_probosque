    ...
    for fileSpot, filePlanet in zip(filesSpot, filesPlanet):
        ...
        if filePlanet == '/data/output/probosque/planet_ndvi/L3/L3_07_20220201_165242_52_248c_3B_AnalyticMS_SR_8b_harmonized_ndvi.tif':
            ...
            for i in range(1,4):
                ...
                os.system('gdal_calc.py --type UInt16 -A '+pathOutput+lineDir+'/'+name+' --outfile='+pathOutputClass+name_class+' --calc="-1*(A<'+inter1+')+0*(A*logical_and(A>='+inter1+',A<='+inter2+'))+1*(A>'+inter2+')"')
