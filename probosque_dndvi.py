...
for line in lines:
    ...
    for fileMeta,file in zip(filesMeta,files):
        ...
        radioSF = file.getElementsByTagName('ps:radiometricScaleFactor')[6].firstChild.data
        refleSF = file.getElementsByTagName('ps:reflectanceCoefficient')[8].firstChild.data
        print(radioSF)
        print(refleSF)
